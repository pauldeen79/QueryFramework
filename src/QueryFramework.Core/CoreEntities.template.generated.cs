...
namespace QueryFramework.Core
{
    ...
    public partial record QuerySortOrder : QueryFramework.Abstractions.IQuerySortOrder
    {
        ...
        public QuerySortOrder(CrossCutting.Utilities.ExpressionEvaluator.IExpression<string> fieldNameExpression, QueryFramework.Abstractions.Domains.QuerySortOrderDirection order)
        {
