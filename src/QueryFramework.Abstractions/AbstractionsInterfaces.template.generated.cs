...
{
    public interface IDataObjectNameQuery : QueryFramework.Abstractions.IQuery
    {
    ...
    public interface IFieldSelectionQuery : QueryFramework.Abstractions.IQuery
    {
        bool Distinct
        {
            get;
    ...
    public interface IGroupingQuery : QueryFramework.Abstractions.IQuery
    {
        [System.ComponentModel.DataAnnotations.RequiredAttribute]
    ...
    public interface IParameterizedQuery : QueryFramework.Abstractions.IQuery
    {
        [System.ComponentModel.DataAnnotations.RequiredAttribute]
        [CrossCutting.Common.DataAnnotations.ValidateObjectAttribute]
    ...
    public interface ISingleEntityQuery : QueryFramework.Abstractions.IQuery
    {
    }
}
#nullable disable
