...
namespace QueryFramework.Abstractions.Builders.Extensions
{
    ...
    public static partial class GroupingQueryBuilderExtensions
    {
        ...
        public static T AddGroupByFilter<T>(this T instance, System.Collections.Generic.IEnumerable<QueryFramework.Abstractions.Builders.IConditionBuilder> groupByFilter)
            where T : QueryFramework.Abstractions.Builders.IGroupingQueryBuilder
        {
            if (groupByFilter is null) throw new System.ArgumentNullException(nameof(groupByFilter));
            return instance.AddGroupByFilter<T>(groupByFilter.ToArray());
        }

        public static T AddGroupByFilter<T>(this T instance, params QueryFramework.Abstractions.Builders.IConditionBuilder[] groupByFilter)
            where T : QueryFramework.Abstractions.Builders.IGroupingQueryBuilder
        {
            if (groupByFilter is null) throw new System.ArgumentNullException(nameof(groupByFilter));
            foreach (var item in groupByFilter) instance.GroupByFilter.Add(item);
            return instance;
        }
    }
    ...
    {
        public static T AddFilter<T>(this T instance, System.Collections.Generic.IEnumerable<QueryFramework.Abstractions.Builders.IConditionBuilder> filter)
        ...
        public static T AddFilter<T>(this T instance, params QueryFramework.Abstractions.Builders.IConditionBuilder[] filter)
            where T : QueryFramework.Abstractions.Builders.IQueryBuilder
        {
            if (filter is null) throw new System.ArgumentNullException(nameof(filter));
