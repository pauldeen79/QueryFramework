...
public class ComposableEvaluatableFieldNameBuilderWrapperTests
{
    [Fact]
    ...
    private static void QueryConditionTest(Func<ComposableEvaluatableFieldNameBuilderWrapper<SingleEntityQueryBuilder>, SingleEntityQueryBuilder> builderDelegate, Type expectedOperatorType)
    {
        // Arrange
