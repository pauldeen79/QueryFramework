...
public class PagedDatabaseEntityRetrieverSettingsProviderMock : IPagedDatabaseEntityRetrieverSettingsProvider
{
    ...
    public Func<ISingleEntityQuery, IPagedDatabaseEntityRetrieverSettings?> ResultDelegate { get; set; } = new Func<ISingleEntityQuery, IPagedDatabaseEntityRetrieverSettings?>(_ => default(IPagedDatabaseEntityRetrieverSettings));
